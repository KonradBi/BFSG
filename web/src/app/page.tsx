...
export default function Home() {
      ...
      <form onSubmit={handleScan} className="relative group">
        <div
          className={`absolute -inset-1.5 rounded-2xl blur opacity-25 group-focus-within:opacity-40 transition duration-500 ${
            variant === "red" ? "bg-red-600" : "bg-gradient-to-r from-navy-800 to-indigo-600"
          }`}
        ></div>
          ...
          <button
            ...
            className={`${
              variant === "red"
                ...
                : "bg-navy-900 hover:bg-navy-800 shadow-slate-900/5"
  ...
  return (
    <main className="min-h-screen bg-background text-foreground selection:bg-slate-500/30 overflow-x-hidden">
      {/* Navigation */}
      <nav className="fixed top-0 w-full z-50 border-b border-slate-200/40 glass">
        <div className="max-w-7xl mx-auto px-4 md:px-8 h-20 flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-10 text-sm font-semibold text-slate-600">
            {NAV_LINKS.map((link) => (
              <Link key={link.href} href={link.href} className="hover:text-navy-800 transition-colors">
                {link.label}
              </Link>
            ))}
          </div>
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="lg:hidden inline-flex items-center justify-center h-10 w-10 rounded-full border border-slate-200 bg-white/70 text-slate-700 hover:text-navy-900 hover:bg-white transition-colors"
            ...
            <Link
              ...
              className="inline-flex lg:hidden items-center justify-center h-10 w-10 rounded-full border border-slate-200 bg-white/70 text-slate-700 hover:text-navy-900"
            >
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <Link href="/scans" className="hidden lg:inline-block text-sm font-bold text-slate-700 hover:text-navy-800 transition-colors">
              Übersicht
            </Link>
            <AuthNav />
          </div>
            ...
            <div className="max-w-7xl mx-auto px-4 py-4 space-y-1">
              {NAV_LINKS.map((link) => (
                <Link
                  ...
                  className="block px-4 py-3 rounded-xl text-base font-bold text-slate-700 hover:text-navy-800 hover:bg-slate-50 transition-colors"
                >
                  {link.label}
                </Link>
              ))}
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="animate-fade-in">
              ...
              <h1 className="text-5xl md:text-7xl font-black tracking-tight mb-8 text-navy-900 leading-[1.1]">
                BFSG 2025 wird verbindlich. Gut vorbereitet, weniger Stress.
              </h1>
              
              <p className="text-xl text-slate-600 mb-10 leading-relaxed max-w-xl">
                Ab Juni 2025 gelten verbindliche Anforderungen an digitale Barrierefreiheit. Ein strukturierter technischer Check hilft, Risiken frueh zu erkennen, Prioritaeten zu setzen und den Aufwand planbar zu machen. Hinweis: keine Rechtsberatung.
              </p>
            ...
            <div className="relative lg:block">
              <div className="absolute -inset-20 bg-slate-100/50 blur-[100px] rounded-full pointer-events-none" />
          ...
          <div className="mt-10 grid lg:grid-cols-2 gap-8 items-start">
            ...
            <section className="rounded-[2.5rem] border border-slate-200 bg-white p-8">
              ...
              <a href="/ratgeber" className="mt-5 inline-flex font-black text-navy-900 hover:text-navy-900">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
            <a href="/bfsg-2025" className="rounded-3xl border border-slate-200 bg-white p-5 hover:bg-slate-50 transition">
              ...
              <div className="mt-3 text-sm font-black text-navy-900">Zum Guide →</div>
            </a>

            <a href="/ratgeber/faq" className="rounded-3xl border border-slate-200 bg-slate-50 p-5 hover:bg-slate-100/60 transition">
              <div className="text-[11px] font-black uppercase tracking-widest text-navy-900">FAQ</div>
              ...
              <div className="mt-3 text-sm font-black text-navy-900">Zur FAQ →</div>
            </a>
            ...
            <a href="/audit-kosten" className="rounded-3xl border border-slate-200 bg-white p-5 hover:bg-slate-50 transition">
              ...
              <div className="mt-3 text-sm font-black text-navy-900">Zu den Kosten →</div>
            </a>
            ...
            <a href="/ratgeber" className="rounded-3xl border border-slate-200 bg-white p-5 hover:bg-slate-50 transition">
              ...
              <div className="mt-3 text-sm font-black text-navy-900">Alle Artikel →</div>
            </a>
          </div>
        </div>
      </section>
      ...
      <section className="section-padding bg-navy-900 text-white relative overflow-hidden">
        ...
        <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-navy-900/10 blur-[150px] rounded-full" />
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={c.t} className="group p-10 rounded-[2.5rem] border border-slate-200 bg-white card-hover">
                <div className="w-14 h-14 rounded-2xl bg-slate-50 text-navy-800 flex items-center justify-center mb-8 group-hover:bg-navy-900 group-hover:text-white transition-colors duration-500">
      ...
      <section className="py-20 bg-white border-y border-slate-100 overflow-hidden relative">
        <div className="absolute top-0 right-0 w-64 h-64 bg-slate-500/5 blur-[100px] rounded-full" />
      ...
      <section id="pakete" className="section-padding">
        <div className="max-w-7xl mx-auto px-6">
            ...
            {[
              ...
              <div 
                ...
                className={`relative p-10 rounded-[3rem] border shadow-2xl transition-all duration-500 scale-100 hover:scale-[1.02] ${
                  c.accent 
                    ? "bg-navy-900 border-navy-900 text-white ring-8 ring-slate-500/10" 
              ...
              >
                ...
                <div className={`text-sm font-black uppercase tracking-[0.2em] mb-4 ${c.accent ? "text-red-400" : "text-navy-800"}`}>{c.t}</div>
          ...
          <p className="mt-4 text-center">
            <Link href="/audit-kosten" className="text-sm font-bold text-navy-800 hover:text-navy-900 transition-colors">
            ...
            {[
              ...
              <details key={f.q} className="group glass p-8 rounded-[2rem] border border-slate-200 cursor-pointer overflow-hidden transition-all duration-300 open:bg-slate-50">
                <summary className="list-none flex justify-between items-center">
                  ...
                  <span className="text-navy-800 transition-transform group-open:rotate-180">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-5 gap-8 md:gap-12">
          ...
          <div>
            ...
            <div className="space-y-3 text-sm font-bold text-slate-500">
              <div><Link href="#audit" className="hover:text-navy-800 transition-colors">Starten</Link></div>
              <div><Link href="#pakete" className="hover:text-navy-800 transition-colors">Preise</Link></div>
              <div><Link href="/scans" className="hover:text-navy-800 transition-colors">Übersicht</Link></div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm font-bold text-slate-500">
              <div><Link href="/ratgeber" className="hover:text-navy-800 transition-colors">Ratgeber</Link></div>
              <div><Link href="/bfsg-2025" className="hover:text-navy-800 transition-colors">BFSG 2025</Link></div>
              <div><Link href="/audit-kosten" className="hover:text-navy-800 transition-colors">Audit-Kosten</Link></div>
              <div><Link href="/ratgeber/faq" className="hover:text-navy-800 transition-colors">FAQ</Link></div>
            </div>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm font-bold text-slate-500">
              <div><Link href="/impressum" className="hover:text-navy-800 transition-colors">Impressum</Link></div>
              <div><Link href="/datenschutz" className="hover:text-navy-800 transition-colors">Datenschutz</Link></div>
              <div><Link href="/agb" className="hover:text-navy-800 transition-colors">AGB</Link></div>
            </div>
          </div>
        </div>
