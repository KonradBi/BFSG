...
1.  [Geltungsbereich & Betroffene](#geltungsbereich--betroffene)
2.  [Fristen & Pflichten](#fristen--pflichten)
3.  [Technische Anforderungen (WCAG/BITV/EN 301 549)](#technische-anforderungen-wcagbitven-301-549)
4.  [Umsetzung & Tests](#umsetzung--tests)
5.  [Kosten & Aufwand](#kosten--aufwand)
6.  [Risiken, Bußgelder & Abmahnungen](#risiken-bußgelder--abmahnungen)
7.  [Dokumentation & Barrierefreiheitserklärung](#dokumentation--barrierefreiheitserklärung)
8.  [Onlineshops, Apps & Medien](#onlineshops-apps--medien)
...
1.  **Wahrnehmbarkeit:** Informationen und Bedienelemente müssen so darstellbar sein, dass Nutzer sie wahrnehmen können. Das bedeutet z.B. Alternativtexte für Bilder oder Untertitel für Videos.
2.  **Bedienbarkeit:** Komponenten der Benutzeroberfläche und die Navigation müssen bedienbar sein. Alles muss per Tastatur erreichbar sein, es darf keine "Tastaturfallen" geben.
3.  **Verständlichkeit:** Informationen und die Bedienung der Benutzeroberfläche müssen verständlich sein. Die Sprache des Inhalts muss maschinenlesbar sein und Fehlermeldungen müssen klar formuliert sein.
4.  **Robustheit:** Inhalte müssen robust genug sein, damit sie von einer Vielzahl von Benutzeragenten, einschließlich assistiver Technologien (z.B. Screenreader), zuverlässig interpretiert werden können. Dies erfordert sauberen, standardkonformen Code.
...
1.  Der Name der Website oder App und des verantwortlichen Unternehmens.
2.  Ein Bekenntnis zur digitalen Barrierefreiheit.
3.  Der "Stand der Vereinbarkeit mit den Anforderungen", also ob die Seite vollständig, teilweise oder nicht konform ist.
4.  Eine Liste der "nicht barrierefreien Inhalte", mit einer Begründung, warum diese nicht konform sind (z.B. unverhältnismäßige Belastung) und welche barrierefreien Alternativen es gibt.
5.  Das Datum der Erstellung der Erklärung und das Datum der letzten Überprüfung.
6.  Eine "Feedback-Möglichkeit": ein Link oder eine E-Mail-Adresse, über die Nutzer Barrieren melden können.
7.  Ein Link zum Schlichtungsverfahren.
...
*   **Gesetzestext BFSG:** [gesetze-im-internet.de/bfsg](https://www.gesetze-im-internet.de/bfsg/)
*   **European Accessibility Act (EAA):** [Richtlinie (EU) 2019/882](https://eur-lex.europa.eu/legal-content/DE/TXT/?uri=CELEX:32019L0882)
*   **Web Content Accessibility Guidelines (WCAG) 2.1 (deutsche Übersetzung):** [bitv-test.de/wcag-werkbank/wcag-21-uebersetzung](https://www.bitv-test.de/wcag-werkbank/wcag-21-uebersetzung.html)
*   **Europäische Norm EN 301 549 (Informationen des ETSI):** [etsi.org/deliver/etsi_en/301500_301599/301549](https://www.etsi.org/deliver/etsi_en/301500_301599/301549/)
*   **BITV 2.0 (für öffentliche Stellen, als Referenz):** [gesetze-im-internet.de/bitv_2_0/](https://www.gesetze-im-internet.de/bitv_2_0/)
*   **Aktion Mensch - Wegweiser Barrierefreiheit:** [aktion-mensch.de/inklusion/barrierefreiheit](https://www.aktion-mensch.de/inklusion/barrierefreiheit)
*   **Überwachungsstelle des Bundes für Barrierefreiheit von Informationstechnik:** [bfit-bund.de](https://www.bfit-bund.de/)
*   **W3C - Web Accessibility Initiative (WAI):** [w3.org/WAI/](https://www.w3.org/WAI/)
