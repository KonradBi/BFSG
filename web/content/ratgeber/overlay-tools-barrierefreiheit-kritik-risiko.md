---
slug: overlay-tools-barrierefreiheit-kritik-risiko
title: 'Accessibility Overlays: Die schnelle Lösung oder rechtliches Risiko?'
...
1.  **Screenreader-Nutzer brauchen kein Overlay:** Blinde Menschen nutzen bereits professionelle Software (z.B. JAWS, NVDA, VoiceOver) auf ihrem Gerät. Ein Overlay stört diese oft, überlagert Tastaturkürzel oder wird gar nicht erst erkannt.
2.  **Strukturfehler bleiben:** Ein Overlay kann eine fehlende Bildbeschreibung (Alt-Text) nicht *inhaltlich* korrekt ergänzen ("Bild 405.jpg" hilft niemandem). Es kann eine unlogische Überschriftenstruktur nicht verstehen. Es kann ein unzugängliches Formular nicht reparieren.
3.  **Performance & Datenschutz:** Viele Overlays laden große Skripte nach, verlangsamen die Seite und senden Nutzerdaten an Drittanbieter-Server (DSGVO-Risiko!).

### Die rechtliche Lage (BFSG & EAA)

Erfüllen Sie mit einem Overlay das Gesetz?
...
1.  Ein sauberes Template / Theme.
2.  Schulung der Redakteure (Alt-Texte, einfache Sprache).
3.  Echte Code-Optimierung.
...
- [WCAG Kontrastwerte prüfen (einfach erklärt)](/ratgeber/wcag-kontrastwerte-pruefen-einfach-erklaert)
- [Tastaturbedienung testen: Anleitung](/ratgeber/tastaturbedienung-testen-anleitung-fokus-tab-reihenfolge)
